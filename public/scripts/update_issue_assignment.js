...
var table_rows = document.getElementsByClassName('table-issue-assignment')
...
for (var row of table_rows) {
    (function (row){
        ...
        row.addEventListener('click', function(){
            ...
            var issueID = row.querySelector('.table-issue-id').innerHTML
            var developerID = row.querySelector('.table-developer-id').innerHTML
            
            // Get access to the input feilds in the form.
            var modalIssueID = document.querySelector('#modal_update_issue_assignment_issueID')
            var modalDeveloperID = document.querySelector('#modal_update_issue_assignment_developerID')
            ...
            $("#updateIssueAssignment").modal("show")
        })
    }(row))
}
